...
import com.sourcecode.malls.web.filter.ApplicationCheckingFilter;
...
public class SecurityConfig extends BaseSecurityConfig {
	...
	@Autowired
	private ApplicationCheckingFilter checkingFilter;
	...
	protected void after(HttpSecurity http) throws Exception {
		...
		http.addFilterAfter(checkingFilter, FilterSecurityInterceptor.class);
	}
}