...
public enum AuthorityDefinitions {
	...
	GOODS_SPECIFICATION_DEFINITION_LIST_IN_CATEGORY("商品规格-列表请求", "AUTH_GOODS_SPECIFICATION_DEFINITION_LIST_IN_CATEGORY", "/goods/specification/definition/listInCategory", "GET"),
