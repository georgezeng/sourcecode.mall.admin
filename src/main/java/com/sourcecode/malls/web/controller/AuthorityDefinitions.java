...
public enum AuthorityDefinitions {
	...
	AUTH_CASH_COUPON_CLIENT_LIST("现金券-列表请求", "AUTH_CASH_COUPON_CLIENT_LIST", "/coupon/cash/client/list", "POST"),
	CASH_COUPON_SETTING_LIST("现金券-列表请求", "AUTH_CASH_COUPON_SETTING_LIST", "/coupon/cash/setting/list", "POST"),
	CASH_COUPON_SETTING_LOAD("现金券-加载请求", "AUTH_CASH_COUPON_SETTING_LOAD", "/coupon/cash/setting/load", "GET"),
	CASH_COUPON_SETTING_FILE_UPLOAD("现金券-上传文件请求", "AUTH_CASH_COUPON_SETTING_FILE_UPLOAD", "/coupon/cash/setting/file/upload", "POST"),
	CASH_COUPON_SETTING_SAVE_BASE_INFO("现金券-保存基本信息请求", "AUTH_CASH_COUPON_SETTING_SAVE_BASE_INFO", "/coupon/cash/setting/save/baseInfo", "POST"),
	CASH_COUPON_SETTING_SAVE_CONDITION_ZS("现金券-保存赠送条件请求", "AUTH_CASH_COUPON_SETTING_SAVE_CONDITION_ZS", "/coupon/cash/setting/save/condition/zs", "POST"),
	CASH_COUPON_SETTING_SAVE_CONDITION_HX("现金券-保存核销条件请求", "AUTH_CASH_COUPON_SETTING_SAVE_CONDITION_HX", "/coupon/cash/setting/save/condition/hx", "POST"),
