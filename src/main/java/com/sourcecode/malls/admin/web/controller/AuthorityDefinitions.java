...
public enum AuthorityDefinitions {
	...
	GOODS_BRAND_LIST_ALL("商品品牌-所有品牌请求", "AUTH_GOODS_BRAND_LIST_ALL", "/goods/brand/list/all", "GET"),
	...
	GOODS_CATEGORY_EDIT_PAGE("商品分类-列表页面", "AUTH_GOODS_CATEGORY_EDIT_PAGE", "/Goods/Category/Edit/Page", "GET"),
	...
	GOODS_CATEGORY_LIST_ALL("商品品牌-所有分类请求", "AUTH_GOODS_CATEGORY_LIST_ALL", "/goods/category/list/all", "GET"),
	GOODS_CATEGORY_LIST_ALL_PARENTS("商品品牌-所有非叶子节点请求", "AUTH_GOODS_CATEGORY_LIST_ALL_PARENTS", "/goods/category/list/allParents", "GET"),
	...
	GOODS_ITEM_EDIT_PAGE("商品-列表请求", "AUTH_GOODS_ITEM_EDIT_PAGE", "/Goods/Item/Edit/Page", "GET"),
	...
	GOODS_SPECIFICATION_DEFINITION_LIST_PAGE("商品规格-索引页面", "AUTH_GOODS_SPECIFICATION_DEFINITION_LIST_PAGE", "/Goods/Specification/Definition/List/Page", "GET"),
	...
	GOODS_SPECIFICATION_DEFINITION_GROUPS("商品规格-列表请求", "AUTH_GOODS_SPECIFICATION_DEFINITION_GROUPS", "/goods/specification/definition/groups", "GET"),
	GOODS_SPECIFICATION_DEFINITION_CATEGORY_ID("商品规格-列表请求", "AUTH_GOODS_SPECIFICATION_DEFINITION_CATEGORY_ID", "/goods/specification/definition/categoryId", "GET"),
